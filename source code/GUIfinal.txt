...
hw_path = "C:\\Users\edwar\Downloads\GUI\Hardware.xlsx"
activity_path = "C:\\Users\edwar\Downloads\GUI\Activity.xlsx"
backup_path = "C:\\Users\edwar\Downloads\GUI\Backup.xlsx"
cs_path = "C:\\Users\edwar\Downloads\GUI\Customer Survey.xlsx"
dept_path = "C:\\Users\edwar\Downloads\GUI\Departments.xlsx"
transactions_path = "C:\\Users\edwar\Downloads\GUI\Transactions.xlsx"
...
class AdminSupervisorEdit(Frame):
    def __init__(self, master):
        ...
        delete = Button(master, text="Delete Supervisor", command=lambda: delSupervisor(new_id.get())).grid(column=1,
                                                                                                            row=5)
        # Employee menu bar
        menubar = Menu(master)
    ...
    def __init__(self, master):
        ...
        def Update_Survey():
            ...
            if (user_Input1.get() == 'Yes'):
                cell1 = ws['B2']
                ws["B2"] = cell1.value + 1
                surYes1 = Label(master, text="Q1: Yes")
                surYes1.place(relx=.5, rely=.7, anchor=CENTER)
                total += 1

            if (user_Input1.get() == 'No'):
                cell1 = ws['C2']
                ws["C2"] = cell1.value + 1
                surNo1 = Label(master, text="Q1: No")
                surNo1.place(relx=.5, rely=.7, anchor=CENTER)
                total2 += 1

            if (user_Input2.get() == 'Yes'):
                cell2 = ws['B3']
                ws["B3"] = cell2.value + 1
                surYes2 = Label(master, text="Q2: Yes")
                surYes2.place(relx=.5, rely=.8, anchor=CENTER)
                total += 1

            if (user_Input2.get() == 'No'):
                cell2 = ws['C3']
                ws["C3"] = cell2.value + 1
                surNo2 = Label(master, text="Q2: No")
                surNo2.place(relx=.5, rely=.8, anchor=CENTER)
                total2 += 1

            if (user_Input3.get() == 'Yes'):
                cell3 = ws['B4']
                ws["B4"] = cell3.value + 1
                surYes3 = Label(master, text="Q3: Yes")
                surYes3.place(relx=.5, rely=.9, anchor=CENTER)
                total += 1

            if (user_Input3.get() == 'No'):
                cell3 = ws['C4']
                ws["C4"] = cell3.value + 1
                surNo3 = Label(master, text="Q3: No")
                surNo3.place(relx=.5, rely=.9, anchor=CENTER)
                total2 += 1

            # Customer Satisfaction Survey should display score
            surTotalYes = Label(master, text="Total(Yes): " + str(total))
            surTotalYes.place(relx=.7, rely=.7, anchor=CENTER)

            surTotalNo = Label(master, text="Total (No): " + str(total2))
            surTotalNo.place(relx=.7, rely=.8, anchor=CENTER)

            surTotalBoth = Label(master,
                                 text="Total Responses: " + str(cell1.value + cell2.value + cell3.value))
            surTotalBoth.place(relx=.7, rely=.9, anchor=CENTER)

            print(cell1.value + cell2.value + cell3.value)

            wb.save(cs_path)

        ttk.Label(master, text="Did you find what you were looking for?").grid(column=0, row=5, padx=10,
                                                                               pady=25)
